...
public class UC09RegistrarEmprestimoDeLivro {
	...
	@Test
	public void CT03RegistraEmprestimoComUsuarioNull() {
		Usuario aluno = null;
	...
	@Test
	public void CT04RegistraEmprestimoComLivroNull() {
		Livro livro = null;
		Emprestimo emprestimo = new Emprestimo();
		try {
	...
	@Test
	public void CT05RegistraEmprestimoComDataInvalida() {
		Emprestimo emprestimo = new Emprestimo();
		try {
			emprestimo.setDataEmprestimo("01.11.2018");
		}catch(RuntimeException e){
